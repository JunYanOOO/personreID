# -*- coding: utf-8 -*-
"""
Created on Thu Dec 14 16:21:20 2023
...
from capture import capture_and_save_video

############改檔案位置處############
#錄製影片輸出位置
output_file='C:/Users/asuka/Desktop/oscar/NEWVideo/output_video.mp4'
#輸入影片
video_input_path = 'C:/Users/asuka/Desktop/oscar/NEWVideo/testme2.mp4'
#輸出影片
video_output_path = 'C:/Users/asuka/Desktop/oscar/NEWVideo/output03.mp4'
#輸出照片路徑
img_output_path = 'C:/Users/asuka/Desktop/oscar/people_realtime'
#照片源文件夹路径
source_folder = 'C:/Users/asuka/Desktop/oscar/people_realtime'
#照片目标文件夹路径
target_folder = 'C:/Users/asuka/Desktop/oscar/people_o_3'
# 改檔名
directory_path = 'C:/Users/asuka/Desktop/oscar/people_o_3'
...
if __name__ == "__main__":
    ...
    capture_and_save_video(output_file,capture_device=0)
    obj = CountObject(output_file, video_output_path)
    obj.process_video()
    #roi_area = [204, 216, 1781, 1080]  # 設定 ROI 的左上角和右下角坐標

    roi_area = [0,0, 640, 480]  # 設定 ROI 的左上角和右下角坐標
    save_detections_from_video(output_file, img_output_path,step=10, min_detection_size=100, roi=roi_area)
